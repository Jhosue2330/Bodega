...
<body class="bodega-page">
  ...
  <main class="wrap">
    <header class="page-head"><h2>➕ Nueva entrada</h2><p class="sub">Registro sin JS</p></header>

    <section class="card form-pane">
      <form class="form" action="<c:url value='/bodeguero/movimientos/entrada-form'/>" method="post">
        ...
        <div class="field">
          ...
          <input class="input" name="motivo" placeholder="Compra / Proveedor / Nota">
        </div>
