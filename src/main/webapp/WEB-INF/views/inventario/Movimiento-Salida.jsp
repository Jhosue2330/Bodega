...
<body class="bodega-page">
  ...
  <main class="wrap">
    <header class="page-head"><h2>➖ Nueva salida</h2><p class="sub">Usando productos de Gestión</p></header>
    <section class="card form-pane">
      <form class="form" action="#" method="post">
        ...
        <div class="field"><label>Referencia</label><input class="input" placeholder="Venta/Delivery/Nota"></div>
        <div class="actions">
