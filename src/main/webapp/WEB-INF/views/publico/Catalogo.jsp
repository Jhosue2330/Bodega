  ...
  <head>
    ...
    <style>
      ...
      @media (min-width: 900px) {
        .toolbar {
          grid-template-columns: 1fr 0.8fr 0.8fr 0.6fr 0.6fr auto;
        }
      }
      .input,
      .select {
  ...
  <body id="topCatalogo">
    ...
    <nav class="navbar">
      ...
      <ul class="nav-links">
        ...
        <li><a class="nav-link active" href="Catalogo.jsp">Catálogo</a></li>
          ...
          <div class="body">
            ...
            >
              ...
              <div class="card-actions">
                <a class="btn" href="#carrito">Comprar</a>
                <a class="btn outline" href="Venta.html">Agregar (admin)</a>
              </div>
            </div>
          </div>
        </article>
        ...
        <div class="dialog" role="dialog" aria-modal="true" aria-labelledby="cartTitle">
          ...
          <div class="card" style="padding: 12px; border-radius: 14px; margin-top: 12px">
            ...
            <p class="note" style="margin-top: 8px">
              Maqueta: al confirmar, el pedido pasaría a Ventas (admin) para validación.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pedido-ok" class="modal" aria-hidden="true">
        <div class="dialog" role="dialog" aria-modal="true" aria-labelledby="okTitle">
          ...
          <p class="sub" style="margin: 6px 0 14px">
            Tu número de pedido es <strong>PED-001</strong>. El bodeguero confirmará stock y
            coordinará la entrega.
          </p>
          ...
          <div class="card" style="padding: 10px; border-radius: 12px; margin-top: 14px">
            <p class="note" style="margin: 0">
              Se conserva el botón <em>Agregar (admin)</em> para el flujo interno en
              <strong>Venta.html</strong>.
            </p>
          </div>
        </div>
      </section>
